...
struct UkrainianDictionary {
    static let values: [String: String] = [
        ...
        "support_us_landing": "Чи підтримаєте ви наш розвиток, залишивши нам оцінку?",

        "landing_3_title": "Ваш Шлях до Свободи",
        "landing_3_description": "Розпочніть свою подорож до безперебійного інтернету.",
        "landing_3_button": "Почати",
